            ...
            <form action="/rekam_medis" method="POST" enctype="multipart/form-data">
                ...
                <div class="row row-cols-1 row-cols-md-3 g-4">
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Tanggal Rekam Medis</h5>
                                <h1><input type="date" class="form-control-plaintext" value="" name="tanggal_rekam_medis"></h1>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h1><input type="int" class="form-control-plaintext" value="" name="berat_janin" placeholder="..."></h1>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h1><input type="int" class="form-control-plaintext" value="" name="panjang_janin" placeholder="..."></h1>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h1><input type="int" class="form-control-plaintext" value="" name="detak_janin" placeholder="..."></h1>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h1><input type="int" class="form-control-plaintext" value="" name="berat_ibu" placeholder="..."></h1>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h1><input type="int" class="form-control-plaintext" value="" name="detak_ibu" placeholder="..."></h1>
                            </div>
                        </div>
                    </div>
                </div>
